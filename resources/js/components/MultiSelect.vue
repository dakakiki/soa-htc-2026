    ...
    <div ref="root" class="relative">
        ...
        >
            <div class="flex min-h-[1.25rem] flex-1 flex-wrap items-center gap-1">
                ...
                <span v-else class="text-gray-400">{{ loading ? t('common.loading') : placeholder }}</span>
            </div>
            ...
            <svg v-else class="h-4 w-4 shrink-0 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
