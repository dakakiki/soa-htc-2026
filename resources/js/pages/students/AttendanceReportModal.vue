    ...
    <div v-if="open" class="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/40 p-4 sm:p-8"
        ...
        <div class="relative w-full max-w-lg rounded-lg bg-white shadow-xl">
            ...
            <div class="space-y-4 p-6">
                ...
                <div>
                    <span class="mb-1 block text-xs font-medium text-gray-500">{{ $t('registration.country') }}</span>
                ...
                <div>
                    <span class="mb-1 block text-xs font-medium text-gray-500">{{ $t('registration.venue') }}</span>
                ...
                <div>
                    <span class="mb-1 block text-xs font-medium text-gray-500">{{ $t('registration.attendanceReport.levels') }}</span>
