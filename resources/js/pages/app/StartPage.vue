 ...
 * browser tab.
 *
 * It carries NO site chrome (`bare`): no masthead, no menu, no footer. The two
 * cards are the whole screen, and a navigation bar above them would only offer
 * a third thing to do to somebody who has just been asked to choose between
 * two. The one way onward from each card is the card.
 *
...
<template>
    <div class="flex min-h-screen flex-col bg-brand-palette-4 text-white">
        <div class="mx-auto flex w-full max-w-[26rem] flex-1 flex-col px-6 pb-9 pt-14 sm:pt-20">
            ...
            <div class="mt-7 grid gap-3.5">
                ...
                <RouterLink :to="{ name: 'login' }" :class="card" class="border border-white/25 bg-white/5 text-white hover:bg-white/10">
