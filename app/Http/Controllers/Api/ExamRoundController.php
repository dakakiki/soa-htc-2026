...
class ExamRoundController extends Controller
{
    ...
    public function index(): JsonResponse
    {
        ...
        return response()->json([
            'data' => ExamRound::query()
                ->orderBy('sort_order')
                ->orderBy('name')
                ->get(['id', 'name', 'active', 'sort_order', 'is_sample']),
        ]);
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return response()->json(['data' => ExamRound::create($data)->only(['id', 'name', 'active', 'sort_order', 'is_sample'])], 201);
    }
    ...
    public function update(Request $request, ExamRound $examRound): JsonResponse
    {
        ...
        return response()->json(['data' => $examRound->only(['id', 'name', 'active', 'sort_order', 'is_sample'])]);
    }
